    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">>
      ...
      <el-table-column prop="management" label="调拨流程" >
        <template slot-scope="scope">
          ...
          <el-tag type="primary" v-if="scope.row.management === 1">待处理</el-tag>
...
<!--      </el-table-column>-->
      ...
      <el-table-column label="操作" width="300">
        <template slot-scope="scope">
          ...
          <!--                编辑与删除按钮-->
<!--          <el-button type="success" @click="handleEdit(scope.row)" v-if="scope.row.management === 1"  >编辑<i class="el-icon-edit-outline"></i></el-button>-->
          ...
          >
            <el-button type="danger" slot="reference" v-if="scope.row.management === 1
    ...
    <el-dialog title="业务信息" :visible.sync="dialogFormVisible" width="30%" >
      <el-form label-width="80px" size="mid">
        ...
        <el-form-item label="调拨申请" >
          <el-radio-group v-model="form.management">
            <el-radio label="1" >
              待处理
            </el-radio>
          </el-radio-group>
...
export default {
  ...
  methods:{
    load(){ //请求分页查询数据，加载页面
      this.request.get("assets/page/management",{
        params:{
